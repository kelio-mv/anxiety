  ...
  return (
    <Page title="Terapia" icon="psychology">
      <div className="max-w-[40rem] space-y-4">
        <p>
          Todas as técnicas que você conheceu ajudam a aliviar os sintomas mas não substituem o
        ...
        <p>
          Ela permite que o paciente identifique e mude padrões de pensamento e de comportamento e
