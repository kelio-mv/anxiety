...
function Diary() {
  ...
  return (
    <Page title="Diário" icon="sticky_note_2">
      ...
      <p>
        Escreva sobre os momentos em que ficou ansioso, quais gatilhos despertaram este sentimento e
        expresse como se sentiu sem medo de julgamentos.
      </p>
...
function Note({ date, content, editNote, deleteNote }) {
  ...
  return (
    <div className="p-2 space-y-2 border border-gray-800 rounded-lg" key={date}>
      ...
      <textarea
        className="block w-full px-2 py-1.5 bg-gray-800 border border-gray-700 rounded overflow-hidden"
        ref={textareaRef}
