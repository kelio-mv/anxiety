  ...
  return (
    <Page title="Respiração" icon="air" flex>
      ...
      <p>
        ...
        inspirando profundamente pelo <span className="underline">nariz</span> enquanto ela se enche
        e expirando lentamente pela <span className="underline">boca</span> enquanto ela se seca.
      </p>
